...
//         // Show the errors to the article
...
//   });
//
//   app.on('createArticle', (form) => {
//
//     const $createArticleError = $('#createArticleError');
//     const $createArticleBtn = $('#createArticleBtn');
//
//     const postData = {
...
//     };
//
//     $('.article-blocks').each(function(index) {
//       const block = {};
...
//       $errorMessage: $('#createArticleError .message'),
//       $btn: $createArticleBtn
//     };
//
//     // Clear the error message div
//     $createArticleError.addClass('hidden');
//
//     // Send Ajax
//     sendDataAjax(options);
//
//     // Disable the submit form button
//     $createArticleBtn.addClass('disabled');
//
//   });
//
//   app.on('editArticle', (form) => {
//
//     const $editArticleError = $('#editArticleError');
//     const $editArticleBtn = $('#editArticleBtn');
//
//     const putData = {
//       title: $('#inputTitle').val(),
//       slug: $('#inputSlug').val(),
...
//       $errorMessage: $('#editArticleError .message'),
//       $btn: $editArticleBtn
//     };
//
//     // Clear the error message div
//     $editArticleError.addClass('hidden');
//
//     // Send Ajax
//     sendDataAjax(options);
//
//     // Disable the submit form button
//     $editArticleBtn.addClass('disabled');
//
//   });
//
//   app.on('deleteArticle', (btn) => {
//
//     if(!confirm('Are you sure to want delete this article?')) return false;
//
//     const $btn = $(btn);
//
